...
static const char *fonts[]          = { "Lilex Nerd Font:style=bold:size=10" };
static const char dmenufont[]       = "Lilex Nerd Font:style=bold:size=10";
...
static const char *clipboard[] = { "clipmenu", "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_gray3, "-sf", col_gray1, NULL };
